...
# AiPro2022フォルダに移動して…
#
# > py  -3.9  -m  venv  .scikit2     ← 新しい仮想環境「.scikit」を生成する
#
# > .scikit2\Scripts\activate.bat    ← 新しい仮想環境「.scikit」を起動する
#
# (.scikit) > python -m pip install -r requirements_scikit2.txt   ← ライブラリの一括インストール
#
...
def main():
    ...
    if choice == 'グラフ表示':
        ...
        if 'df' in st.session_state:
            ...
            # グラフの表示
            #xaxis = {"dtick" : 2500, "range":(0,20000),}
            #plt.tight_layout()
